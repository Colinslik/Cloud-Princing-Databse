...
class InstanceList(Resource):
    ...
    def get(self, vendor, region):
        ...
        return {'instances': rows, 'count': len(rows), 'offset': offset, 'total': total}, OK
    ...
    def put(self, vendor, region):
        ...
        return json.dumps({'instances': instances}, ensure_ascii=False).decode('utf-8'), OK
